...
public class EntityTotem extends EntityLiving {
    private int duration = 200; // Продолжительность в тиках (10 секунд)
    private int tickCounter = 0;
    private EntityPlayer owner; // Игрок, который поставил тотем

    public EntityTotem(World worldIn) {
        super(worldIn);
        this.setSize(1.0F, 1.0F);
    }

    public EntityTotem(World worldIn, EntityPlayer owner, double x, double y, double z) {
        this(worldIn);
